...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/modern/app-assets/css/core/menu/menu-types/vertical-overlay-menu.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/modern/app-assets/css/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/modern/app-assets/vendors/css/cryptocoins/cryptocoins.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/modern/app-assets/vendors/css/charts/apexcharts.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-overlay-menu 2-columns   fixed-navbar" data-open="click" data-menu="vertical-overlay-menu" data-col="2-columns">
        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="modern admin logo" src="<?= base_url() ?>/assets/modern/app-assets/images/logo/logo.png">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail"></i></a>
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                ...
                                <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?= base_url() ?>/assets/modern/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="<?= base_url() ?>/assets/modern/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?= base_url() ?>/assets/modern/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="<?= base_url() ?>/assets/modern/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow menu-border" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="../ecommerce-menu-template"><i class="la la-shopping-cart"></i><span class="menu-title" data-i18n="eCommerce">eCommerce</span></a>
                </li>
                <li class=" nav-item"><a href="../travel-menu-template"><i class="la la-plane"></i><span class="menu-title" data-i18n="Travel &amp; Booking">Travel &amp; Booking</span></a>
                </li>
                <li class=" nav-item"><a href="../hospital-menu-template"><i class="la la-stethoscope"></i><span class="menu-title" data-i18n="Hospital">Hospital</span></a>
                </li>
                <li class=" nav-item"><a href="../crypto-menu-template"><i class="la la-bitcoin"></i><span class="menu-title" data-i18n="Crypto">Crypto</span></a>
                </li>
                <li class=" nav-item"><a href="../support-menu-template"><i class="la la-tag"></i><span class="menu-title" data-i18n="Support Ticket">Support Ticket</span></a>
                </li>
                <li class=" nav-item"><a href="../bank-menu-template"><i class="la la-bank"></i><span class="menu-title" data-i18n="Bank">Bank</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="la la-puzzle-piece"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-1-column.html"><i></i><span data-i18n="1 column">1 column</span></a>
                        </li>
                        <li><a class="menu-item" href="#"><i></i><span data-i18n="Content Det. Sidebar">Content Det. Sidebar</span></a>
                            <ul class="menu-content">
                                <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-content-detached-left-sidebar.html"><i></i><span data-i18n="Detached left sidebar">Detached left sidebar</span></a>
                                </li>
                                <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-content-detached-left-sticky-sidebar.html"><i></i><span data-i18n="Detached sticky left sidebar">Detached sticky left sidebar</span></a>
                                </li>
                                <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-content-detached-right-sidebar.html"><i></i><span data-i18n="Detached right sidebar">Detached right sidebar</span></a>
                                </li>
                                <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-content-detached-right-sticky-sidebar.html"><i></i><span data-i18n="Detached sticky right sidebar">Detached sticky right sidebar</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-fixed-navbar.html"><i></i><span data-i18n="Fixed navbar">Fixed navbar</span></a>
                        </li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-fixed-navigation.html"><i></i><span data-i18n="Fixed navigation">Fixed navigation</span></a>
                        </li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-fixed-navbar-navigation.html"><i></i><span data-i18n="Fixed navbar &amp; navigation">Fixed navbar &amp; navigation</span></a>
                        </li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-fixed-navbar-footer.html"><i></i><span data-i18n="Fixed navbar &amp; footer">Fixed navbar &amp; footer</span></a>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-fixed.html"><i></i><span data-i18n="Fixed layout">Fixed layout</span></a>
                        </li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-boxed.html"><i></i><span data-i18n="Boxed layout">Boxed layout</span></a>
                        </li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-static.html"><i></i><span data-i18n="Static layout">Static layout</span></a>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-light.html"><i></i><span data-i18n="Light layout">Light layout</span></a>
                        </li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-dark.html"><i></i><span data-i18n="Dark layout">Dark layout</span></a>
                        </li>
                        <li><a class="menu-item" href="<?= base_url() ?>/assets/modern/starter-kit/ltr/vertical-overlay-menu-template/layout-semi-dark.html"><i></i><span data-i18n="Semi dark layout">Semi dark layout</span></a>
                        </li>
                    </ul>
                </li>
    ...
    <!-- Buynow Button-->
    <div class="buy-now"><a href="https://1.envato.market/modern_admin" target="_blank" class="btn btn-info btn-glow round px-2">Buy Now</a></div>
    ...
    <script src="<?= base_url() ?>/assets/modern/app-assets/vendors/js/charts/apexcharts/apexcharts.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <script src="<?= base_url() ?>/assets/modern/app-assets/js/scripts/customizer.min.js"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="<?= base_url() ?>/assets/modern/app-assets/js/scripts/pages/dashboard-crypto.js"></script>
    <!-- END: Page JS-->
